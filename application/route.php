...
Route::put('test/:id','api/test/updata');//修改
Route::delete('test/:id','api/test/delete');//删除

Route::resource('test','api/test');
//x.com/test  post 这个方法是通用的
Route::resource('test/','api/test');
...
//app登入的路由
Route::post('api/:ver/login','api/:ver.login');
Route::post('api/:ver/login','api/:ver.login/save');

Route::resource('api/:ver/user1','api/:ver.user1');

//图片上传
Route::post('api/:ver/imageUser','api/:ver.imageUser/save');
